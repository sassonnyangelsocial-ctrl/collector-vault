...
as $$
begin
  if new.created_at >= timestamptz '2026-08-16 00:00:00 America/New_York'
     and new.created_at < timestamptz '2026-08-18 00:00:00 America/New_York' then
...
where m.user_id = u.id
  and u.created_at >= timestamptz '2026-08-16 00:00:00 America/New_York'
  and u.created_at < timestamptz '2026-08-18 00:00:00 America/New_York'
